...
$(document).ready(function(){
	username = prompt("Enter your username: " , "harry123");
	if(username != null){
		socket.emit("set username",{username: username},function(data){
		});
	}
...
function closeIt()
{
  socket.emit("disconnect user",{username: username},function(data){
    });
}
